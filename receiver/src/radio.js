...
var Pipes= ["0x65646f4e32","0x65646f4e31"]; // "1Node", "2Node"
...
function rcv(){
  ...
  radio.read(function(d,items) {
    ...
    for(var i=0;i<items;i++){
      ...
      //let r=d[i].data.readUInt32LE(0); // lese das [i] item als Int
      console.log("Payload Rcv ["+ charCodeAt +"], reply result:" + radio.write(d[i].data));
    }
    */
